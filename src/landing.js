        ...
        <div className='landing'>
            <div className='landingtext'>
                <div>
                    ...
                    <p style={{ fontFamily: 'poppins', fontSize: "3.1rem", margin: "20px 0", padding: "0", lineHeight: '1.1', fontWeight: '800' }}>Save <span className="big">big</span> with our car rental</p>
