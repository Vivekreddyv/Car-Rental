...
const Banner=()=>{
    return(
        <div className='banner'>
            ...
            <h2 style={{color:'white',fontFamily:'poppins',margin:'10px 0 0 0',fontWeight:'400',fontSize:'1.5rem'}}>Top Airports. Local Suppliers. <span style={{color:'#ff4d30'}}>24/7</span> Support.</h2>
            </div>
            <div>
