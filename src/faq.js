    ...
    return(
        <div className="faqmain">
            ...
            <div className={`${activequestion("q2")}`} onClick={()=>activeq("q2")}>
                ...
                {active==="q2"&& <p style={{color:'#706f7b',padding:'15px 40px 30px 40px',lineHeight:'1.7',fontFamily:'rubik'}} onClick={()=>activeq("q2")}>You can find car rental deals by researching online and
            ...
            <div className={`${activequestion("q3")}`} onClick={()=>activeq("q3")}>
                ...
                {active==="q3"&& <p style={{color:'#706f7b',padding:'15px 40px 30px 40px',lineHeight:'1.7',fontFamily:'rubik'}} onClick={()=>activeq("q3")}>Book in advance: Booking your rental car ahead of time can
